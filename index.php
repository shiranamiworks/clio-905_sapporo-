...
<div id="splash">
  <div class="splash_logo"><img src="img/loading_logo.svg" alt="" class=""></div>
...
<div class="_top-cv-btn_fadein pc">
  <div class="top-cv-btn pc">
    <ul>
      <li> <a href="https://www.meiwajisyo.co.jp/form/request_nw/?bunjo_number=2000233M2220050" class="gtm_cv_request_trg" id="cv_top_request" target="_blank">資料請求</a> </li>
...
<section id="contentsWrap"> 
  ...
  <section class="sec-information inner ac">
    ...
    <div class="fade-in fade-in-up">
      ...
      <div class="open"> 
        ...
        <!-- <p class="txt-open"><span class="d-inline-block">「クリオ ライフスタイルサロン札幌」<br class="sp">
          公開中</span></p> -->
        <p class="entend-time">資料請求受付中</p>
        <!-- <p class="reserve-time mt15"><span class="note d-block"><span class="num">事前案内会開催中</span>〈完全予約制〉</span><br> ①10:00～&nbsp;②13：00～&nbsp;③16：00～&nbsp;④19：00～</p> -->
      </div>
    ...
    <div class="top-banner">
      <div class="bnrs cs15_bnr"> <a href="https://www.meiwajisyo.co.jp/special/gallery/" target="_blank"><img src="https://www.meiwajisyo.co.jp/clio/banner/gallery/bnr.jpg" alt="竣工物件ギャラリー"></a> </div>
    </div>
    <div class="top-banner">
...
<section id="contentsWrap"> 
    ...
    <section id="access" class="sec-access fade-in fade-in-up">
      <div class="access_con contents">
        <p class="eng slidein"><span class="CormorantGaramond">ACCESS</span></p>
        <div class="left">
          <h2>アクセス</h2>
          <p>北海道最大のターミナル駅<br />
            「札幌」駅を最寄り駅に<br>
        ...
        <div class="right">
          <div class="photo"><img src="img/access_img.png" alt="Image Photo" class="Parallax_l">
            <p class="cap">空撮写真</p>
          </div>
          <div class="bg_white"></div>
          <div class="bg_green slidein"></div>
          <p class="btn tbsp"><a href="access/" class="gtm_cv_reserve_trg" id="cv_access">VIEW DETAIL</a></p>
        </div>
      </div>
    </section>
    ...
    <section id="location" class="sec-location fade-in fade-in-up">
      <div class="location_con contents">
        <p class="eng slidein"><span class="CormorantGaramond">LOCATION</span></p>
        <div class="left">
          <div class="photo"> <img src="img/location_img.png" alt="Image Photo" class="Parallax_r">
            <p class="cap">JRタワー（徒歩10分／約740m）</p>
          </div>
          <div class="bg_white"></div>
          <div class="bg_green slidein slidein_r"></div>
          <p class="btn tbsp"><a href="location/" class="gtm_cv_reserve_trg" id="cv_location02">VIEW DETAIL</a></p>
        </div>
        <div class="right">
          <h2>ロケーション</h2>
          <p>ライフステージは再開発で<br>
            期待高まる札幌駅前エリア。</p>
          <p class="btn pc"><a href="location/" class="gtm_cv_reserve_trg" id="cv_location">VIEW DETAIL</a></p>
          <p class="colorbar"><img src="img/colorbar.svg"></p>
        </div>
      </div>
    </section>
    ...
    <section id="plan" class="sec-plan fade-in fade-in-up">
      <div class="plan_con contents">
        <p class="eng slidein"><span class="CormorantGaramond">PLAN</span></p>
        <div class="left">
          <h2>プラン</h2>
          <p>札幌都心では得がたい<br>
            緑の風景と開放感あふれる暮らし</p>
          <p class="btn pc"><a href="plan/" class="gtm_cv_reserve_trg" id="cv_plan">VIEW DETAIL</a></p>
          <p class="colorbar"><img src="img/colorbar.svg"></p>
        </div>
        <div class="right">
          ...
          <div class="bg_white"></div>
          <div class="bg_green slidein"></div>
          <p class="btn tbsp"><a href="plan/" class="gtm_cv_reserve_trg" id="cv_location">VIEW DETAIL</a></p>
        </div>
      </div>
    </section>
      ...
      <div class="inner">
        ...
        <div class="swiper-pickup fade-in fade-in-up">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"> <a href="http://www.meiwajisyo.co.jp/corp/pdf/meiwa_SUUMOAWARD2024.pdf" target="_blank" class="gtm_click_trg" id="view_suumoaward2022">
              <div class="inner_card">
                <div class="imgBox"> <img src="https://www.meiwajisyo.co.jp/clio/banner/suumo/suumo-award2024.jpg" alt="AWARD 2024"> </div>
                <div class="txtarea">
