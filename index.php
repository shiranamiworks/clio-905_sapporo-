  ...
  <body class="base">
    ...
    <div class="page" id="pageID">
      ...
      <section id="contentsWrap">
        ...
        <div class="mv">
          <div class="image"><img src="img/mv-sold.jpg" alt="" class="pctb" /><img src="img/mv-sold-sp.jpg" alt="" class="sp" /><p class="cap">エントランス完成予想図</p></div>
        </div>

        <div class="cancel">
          <div class="bnr_cancel">
            <a href="https://www.meiwajisyo.co.jp/form/waitinglist/?bunjo_number=2000233M2220050" target="_blank"><img src="img/bnr_cancel.png" alt="" /></a>
          </div>
...
-->
          ...
          <div class="video-wrap fade">
            ...
            <div class="vision-text sp_harf fadein">
              <h3 class="ttl fadein scroll-in">
                <img src="img/vision_txt.svg" alt="SAPPORO NEXT VISION" />
              </h3>
            </div>
            <div class="vision-text sp_harf fadein">
              <p class="vision_read">
      ...
      <section id="contentsWrap">
        ...
        <section id="access" class="sec-access fade-in fade-in-up">
          <div class="access_con contents">
            <p class="eng slidein">
              <span class="CormorantGaramond">ACCESS</span>
            </p>
            <div class="left">
              <h2>アクセス</h2>
              <p>
        ...
        <!-- /location -->
        <section id="location" class="sec-location fade-in fade-in-up">
          <div class="location_con contents">
            <p class="eng slidein">
              <span class="CormorantGaramond">LOCATION</span>
            </p>
            <div class="left">
              <div class="photo">
        ...
        <!-- /plan -->
        <section id="plan" class="sec-plan fade-in fade-in-up">
          <div class="plan_con contents">
            <p class="eng slidein">
              <span class="CormorantGaramond">PLAN</span>
            </p>
            <div class="left">
              <h2>プラン</h2>
              <p>
            ...
            <div class="right">
              <div class="photo">
                ...
                <p class="cap">リビング・ダイニング・キッチン完成予想図(Aタイプ／有償設計変更プラン／分譲済)</p>
              </div>
              <div class="bg_white"></div>
              <div class="bg_green slidein"></div>
              <p class="btn tbsp">
...
-->
                ...
                <div class="swiper-slide">
                  <a href="https://www.meiwajisyo.co.jp/special/gooddesign/" target="_blank" class="gtm_click_trg" id="view_gooddesign2024">
                    <div class="inner_card">
                      <div class="imgBox">
                        <img src="https://www.meiwajisyo.co.jp/clio/banner/gooddesign/bnr_2024.jpg" alt="GOOD DESIGN AWARD 2024" />
                      </div>
                      <div class="txtarea gd">
                        <p class="ttl EBgaramond">GOOD DESIGN AWARD 2024</p>
                        <p class="more EBgaramond">view more</p>
                      </div>
                    </div>
                  </a>
                ...
                <div class="swiper-slide">
                  <a href="https://www.meiwajisyo.co.jp/corp/pdf/meiwa_SUUMOAWARD2025.pdf" target="_blank" class="gtm_click_trg" id="view_suumoaward2024">
                    <div class="inner_card">
                      <div class="imgBox">
                        <img src="https://www.meiwajisyo.co.jp/clio/banner/suumo/suumo-award2025.jpg" alt="SUUMO AWARD 2025" />
                      </div>
                      <div class="txtarea">
                        <p class="ttl EBgaramond">SUUMO AWARD 2025</p>
                        <p class="more EBgaramond">view more</p>
                      </div>
                    </div>
                  </a>
        ...
        <section class="foot-caption inner">
          <p>
            ...
            <br />※北海道新幹線延伸・北海道新幹線札幌駅（2030年度開業予定）出典：新幹線札幌駅の概要について-JR北海道 <br />※北5西1・西2地区市街地再開発事業（2028年度竣工予定）出典：札幌駅交流拠点北5西1・西2地区市街地再開発準備組合 <br />※札幌駅南口北4西3地区第一種市街地再開発事業（2028年度竣工予定）出典：（仮称）札幌駅南口北4西3地区第一種市街地再開発事業 <br />※掲載の外観完成予想図は、設計段階の図面を基に描き起こしたもので、形状・色等は実際とは異なる場合があります。形状の細部、設備機器等は表現していません。表現されている植栽は設計段階のものであり、変更になる合があります。また葉の色合いや枝ぶりや樹形は想定であり、竣工から生育期間を経た状態のものを描いています。また特定の季節状態を示すものではありません。敷地周辺の建物などについては簡略化しています。<br />-->※掲載のエントランス完成予想図は、設計段階の図面を基に描き起こしたもので、形状・色等は実際とは異なる場合があります。形状の細部、設備機器等は表現していません。表現されている植栽は設計段階のものであり、変更になる場合があります。また葉の色合いや枝ぶりや樹形は想定であり、竣工から生育期間を経た状態のものを描いています。また特定の季節状態を示すものではありません。敷地周辺の建物などについては簡略化しています。<!-- <br />※掲載の航空写真は2021年10月に撮影したものに⼀部ＣＧ処理したもので、実際とは異なります。現地の光は位置を表すものであり、物件の⼤きさや⾼さを表したものではありません。<br />※掲載のリビング・ダイニング・キッチン完成予想図（Aタイプ／有償設計変更プラン／分譲済）は、設計段階の図⾯を基に描き起こしたものに現地12階相当の眺望写真（2022年7⽉撮影）を合成したもので、形状・⾊等は実際とは異なる場合があります。⼀部施⼯上変更する場合がございます。形状の細部、設備機器等は表現していません。また、家具・調度品・有償オプション等は販売価格に含まれません。眺望については将来に渡って保証するものではありません。予めご了承ください。 <br />※表示の徒歩分数は1分＝80mで計算した概算であり、端数は切り上げています。-->
          </p>
        </section>
      </section>
